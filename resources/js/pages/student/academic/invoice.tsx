...
export default function StudentInvoice({ invoice, company }: { invoice: any, company: any }) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'My Payments', href: '/academic/payments' }, { title: 'Invoice', href: '#' }]}>
            ...
            <div className="w-full p-4 space-y-3 print:p-0 print:space-y-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 print:hidden">
                    <div className="flex items-center gap-3">
                        <Link href="/academic/payments" className="p-2 hover:bg-muted rounded-sm border border-border text-muted-foreground hover:text-foreground transition-colors shrink-0">
                ...
                <div className="max-w-[850px] mx-auto print:max-w-none">
                    <div className="invoice-container bg-white border border-black text-[11px] leading-tight text-black font-serif overflow-hidden print:border-[1px] relative">
