        ...
        <div className="w-full p-4 lg:p-6 font-sans selection:bg-primary/20">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-black tracking-tight mb-2">One Last Step!</h1>
                    ...
                    >
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="font-black text-lg tracking-tight uppercase">{batch.name}</span>
                                            <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded tracking-widest ${batch.type === 'online' ? 'bg-blue-100 text-blue-700' : 'bg-orange-100 text-orange-700'}`}>
                                                {batch.type}
                                            </span>
                                        </div>
                        ...
                        {enrollment.course.batches.length === 0 && (
                            <div className="p-12 text-center border-2 border-dashed border-border rounded-[2rem]">
                                ...
                                <p className="text-muted-foreground font-bold uppercase tracking-widest text-xs">No batches available currently</p>
                            </div>
                        )}
                    </RadioGroup>
